...
import os                                     #no need to install part of standard python library
import webbrowser                             #no need to install part of standard python library
import subprocess                             #no need to install part of standard python library  #used to open os apps like calc etc..
import datetime                               #no need to install part of standard python library
    ...
    while 1:
        ...
        #Using Beautiful Soup for WebScrapping
            ...
            if results:
                ...
                s = "shorten the following answer in strictly not more than 30 words ,\" "
                ...
                say(chat_completion.choices[0].message.content or "")
